...
EspalexaDevice::EspalexaDevice(String deviceName, BrightnessCallbackFunction gnCallback, uint8_t initialValue)
{ // constructor for dimmable device
...
EspalexaDevice::EspalexaDevice(String deviceName, ColorCallbackFunction gnCallback, uint8_t initialValue)
{ // constructor for color device
...
EspalexaDevice::EspalexaDevice(String deviceName, DeviceCallbackFunction gnCallback, EspalexaDeviceType t, uint8_t initialValue)
{ // constructor for general device

#ifdef ESPALEXA_DEBUG
  Serial.printf("create EspalexaDevice(%s,%s)\r\n", deviceName, "onoff");
#endif
  _deviceName = deviceName;
